...
class SaleWorkOrder(models.Model):
    ...
    team_leader_id = fields.Many2one(comodel_name='res.user', string='Service Team Leader', required=True)
    team_member_ids = fields.Many2many(comodel_name='res.user', string='Service Member', required=True)
    ...
    planned_end = fields.Datetime(string='planned_end', default=datetime.today() + timedelta(days=1), required=True)
